...
public class WeatherFetcher {
    ...
    public static List<Double> teploty;
    ...
    public static void loadJSON(File file) throws IOException {
        ...
        List<Double> teplotyList = new ArrayList<>();
        ...
        for (int i = 0; i < dny.toList().size(); i++) {
            ...
            teplotyList.add(teplotniRozdil);
    ...
    private static void getYearlyData(JSONObject daily) throws IOException {
        ...
        seasonalTemps.put("rok", new ArrayList<>());
        ...
        for (int i = 0; i < pocetRoku; i++) {
            ...
            seasonalTemps.get("rok").add(zaokrouhli(avgTeplota));
            ...
            System.out.println("ROK: median = " + median(seasonalTemps.get("rok")) + " °C, modus = " + modus(seasonalTemps.get("rok")) + " °C");
